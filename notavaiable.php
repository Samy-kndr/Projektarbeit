...
<html>
	<head>
		<title>Home</title>
        <meta charset="UTF-8">
        <link rel="stylesheet" id="stylesheet_site" media="screen" type="text/css" href="./Stylesheets/Light/Custom/stylesheet_notaviable_light.css" title="light">
        ...
        <link rel="alternate stylesheet_site" media="screen" type="text/css" href="./Stylesheets/Dark/Custom/stylesheet_notaviable_dark.css" title="dark">
            ...
            (function () {
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (localStorage.getItem("theme") == "dark") {
                        ...
                        currentSheetSITE.href = "./Stylesheets/Dark/Custom/stylesheet_notaviable_dark.css";
                        currentSheetSTD.href = "./Stylesheets/Dark/Standard/stylesheet_standard_dark.css";
                    } else {
                        currentSheetSITE.href = "./Stylesheets/Light/Custom/stylesheet_notaviable_light.css";
	...
	<body>
        ...
        <main>
            ...
            <div id="main_content">
                    <div id="main_main_content_mistake">
                        <p>Sorry, there`s a mistake!</p>
                        <p>This is comming soon!</p>
                    </div>
            </div>
